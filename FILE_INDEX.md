...
- `authorities/03_INFORMATION_ARCHITECTURE_AND_UX.md`
- `authorities/04_DESIGN_AUTHORITY.md`
- `authorities/05_RUNTIME_ARCHITECTURE.md`
- `authorities/06_FCC_GATEWAY_AND_AGENT_CATALOG.md`
- `authorities/07_PLANNER_AND_RUNS.md`
- `authorities/08_WORKERS_INTERACTIVE_CODING_SESSIONS.md`
- `authorities/09_CHATS_AND_GPT.md`
- `authorities/10_GIT_ISOLATION_AND_SAFETY.md`
- `authorities/11_DATA_MODEL_AND_SQLITE.md`
- `authorities/12_BENCHMARKING_AND_TELEMETRY.md`
- `authorities/13_SECURITY_AND_PROCESS_MODEL.md`
